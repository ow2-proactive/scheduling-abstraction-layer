...
sudo -H -u ubuntu bash -c 'wget https://raw.githubusercontent.com/ow2-proactive/scheduling-abstraction-layer/master/docker/bootstrap-scripts/nm-bootstrap-script.sh && chmod +x nm-bootstrap-script.sh'
